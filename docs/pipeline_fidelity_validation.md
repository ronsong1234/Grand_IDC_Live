...
**IDC Version:** v24
**Claim:** The direct-DICOM inference path faithfully executes the GrandQC model on NCI Imaging Data Commons DICOM series. This document contains the historical two-slide pixel-fidelity subset and the 15-slide run-success cohort; use `docs/metric_guide.md` and `outputs/validation/validation_report.md` for the current 5-slide Dice headline.
...
|:----------------|-------:|:-------|
| Historical pixel-level fidelity subset | 2 TCGA-BRCA DX | >= 99.99% pixel agreement; Dice >= 0.9956 on all present classes |
| Pipeline reliability across diverse TCGA collections | 15 slides, 5 collections | 15/15 succeeded (100%); 0 failures |

---

## Part 1 - Historical Pixel Fidelity Subset
...
## Part 2 Ã¢â‚¬â€ Pipeline Reliability Across 15 TCGA Slides
...
| Slide sizes processed | 9.1 MB Ã¢â‚¬â€œ 82.2 MB |
| MPP values handled | 0.252 Ã¢â‚¬â€œ 0.501 Ã‚Âµm/px |
...
|:-----------|:------|-------:|---------:|:------:|:----:|------------:|-----:|---------:|----:|-----:|----:|
| tcga_brca | TCGA-OL-A5RW-01Z-00-DX1 | 51.4% | 1.1% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 50 | 0.06% | 0.95% | 0.00% | 0.05% | 0.00% |
| tcga_brca | TCGA-OL-A5S0-01Z-00-DX1 | 71.6% | 1.6% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 58 | 1.51% | 0.07% | 0.00% | 0.00% | 0.01% |
| tcga_coad | TCGA-A6-3810-01Z-00-DX1 | 41.9% | 3.2% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 262 | 2.14% | 0.31% | 0.00% | 0.00% | 0.79% |
| tcga_coad | TCGA-AA-3489-01Z-00-DX1 | 16.7% | 3.8% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 21 | 0.11% | 0.74% | 0.00% | 0.00% | 2.94% |
| tcga_coad | TCGA-AA-3506-01Z-00-DX1 | 37.4% | 28.5% | Ã¢â‚¬â€ | Ã¢â‚¬â€ | 93 | 0.27% | 23.80% | 0.02% | 0.92% | 3.53% |
| tcga_coad | TCGA-AA-3511-01Z-00-DX1 | 55.4% | 71.1% | Ã¢â‚¬â€ | Ã¢Å¡â€˜ | 38 | 1.08% | 65.74% | 0.33% | 3.93% | 0.00% |
| tcga_coad | TCGA-AA-3662-01Z-00-DX1 | 37.3% | 41.4% | Ã¢â‚¬â€ | Ã¢â‚¬â€ | 32 | 1.70% | 25.56% | 0.45% | 1.27% | 12.41% |
| tcga_coad | TCGA-AD-6895-01Z-00-DX1 | 58.1% | 0.5% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 77 | 0.14% | 0.06% | 0.00% | 0.17% | 0.13% |
| tcga_coad | TCGA-AD-6899-01Z-00-DX1 | 34.0% | 0.0% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 224 | 0.00% | 0.00% | 0.01% | 0.00% | 0.00% |
| tcga_esca | TCGA-M9-A5M8-01Z-00-DX1 | 41.8% | 1.2% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 70 | 1.04% | 0.00% | 0.01% | 0.00% | 0.11% |
| tcga_esca | TCGA-V5-A7RE-01Z-00-DX1 | 4.4% | 48.1% | Ã¢â‚¬â€ | Ã¢â‚¬â€ | 43 | 1.96% | 0.03% | 0.00% | 0.00% | 46.10% |
| tcga_kirc | TCGA-A3-3365-01Z-00-DX1 | 44.4% | 5.9% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 144 | 1.38% | 0.69% | 0.14% | 0.11% | 3.56% |
| tcga_kirc | TCGA-A3-3385-01Z-00-DX1 | 40.8% | 0.2% | Ã¢Å“â€œ | Ã¢â‚¬â€ | 126 | 0.10% | 0.09% | 0.00% | 0.03% | 0.00% |
| tcga_luad | TCGA-05-4425-01Z-00-DX1 | 44.9% | 99.3% | Ã¢â‚¬â€ | Ã¢Å¡â€˜ | 21 | 0.00% | 90.22% | 0.00% | 7.59% | 1.49% |
| tcga_luad | TCGA-05-5715-01Z-00-DX1 | 27.5% | 21.4% | Ã¢â‚¬â€ | Ã¢â‚¬â€ | 21 | 0.56% | 4.06% | 0.02% | 13.77% | 2.97% |

*Ã¢Å¡â€˜ = flagged for manual review (single artifact class > 60% or total artifact > 90%)*
*Usable threshold: total artifact fraction of tissue < 20%*
*OOF = out-of-focus*

### Notes on flagged slides

- **TCGA-AA-3511** (COAD): 65.7% darkspot/foreign object. Flagged correctly Ã¢â‚¬â€ this slide has significant tissue preparation artifacts.
...
- **TCGA-V5-A7RE** (ESCA): 4.4% tissue coverage Ã¢â‚¬â€ nearly all background. The model correctly identifies no usable tissue.

These are successful pipeline runs, but the high darkspot/foreign-object examples remain model-behavior findings that should be confirmed in IDC SLIM and audited in `notebooks/failure_mode_darkspot.ipynb`.
