...
def build_payload(slide_dir: Path, row: dict[str, Any]) -> dict[str, Any]:
    ...
    payload = {
        ...
        "tissue_detection_suspect": bool(row.get("tissue_detection_suspect", False)),
        "tissue_detection_reason": str(row.get("tissue_detection_reason") or ""),
        "tissue_detection_tissue_fraction": as_float(row.get("tissue_detection_tissue_fraction")),
        "thumbnail_foreground_fraction": as_float(row.get("thumbnail_foreground_fraction")),
